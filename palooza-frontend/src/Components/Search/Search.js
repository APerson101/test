...
import {Alert, Chip, FormControl, InputLabel, MenuItem, Select, Snackbar} from "@mui/material";
  ...
  return (
    <>
      <div className={"SearchBarContainer " + (searchStarted ? "collapsed" : "") + (isLoading ? " loading" : "")} >
        <Title className="CompanyLogo">SoftAI{searchStarted ? "" : ": Your digital research assistant"}</Title>
